        ...
        <div class="App">
            <div dir="ltr"
                ...
                <a href="/register"><img src="assets/i/arrow_back_two.svg" class=""></a><span
                    class="text-black font-14 fontw600 text-left pl-2">Sign In</span></div>
            ...
            <div dir="ltr" class=" h-100 py-4 z2 position-relative container">
                <form action="" method="POST" dir="ltr" class="mx-540 mx-auto w-100">
   {!! csrf_field() !!}     

                    <div class="mb-2"><input placeholder="Username" name="email" type="email" id="formBasicEmail"
                            class="border-0 font-12 en-input raduis-6 h45 form-control" value=""><span
                            class="text-danger"></span></div>
                    <div class="mb-4"><input placeholder="Password" name="password" type="password"
                            id="formBasicPassword" class="border-0 font-12 en-input raduis-6 h45 form-control"
                            value=""><span class="text-danger"></span></div><button type="submit"
                        class="w-100 font-en font-14 fontw600 h45 raduis-6 btn btn-primary btn-lg">Sign
                        in</button><small class="text-muted font-12 text-center mt-3 form-text">Do not have an
                        account?<a class="font-14 fontw600 ml-2" href="/register">Sign Up</a></small>
                </form>
            </div>
